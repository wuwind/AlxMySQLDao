...
public class T_task_engineer implements Table{
...
public T_task_engineer(java.lang.Integer id ,java.lang.Integer user_id ){
 super();
this.id = id;
this.user_id = user_id;
}
public T_task_engineer(){}
